...
function markerOnClick(featureProperties) {
  console.log(featureProperties); // Para ver las propiedades disponibles en la consola
  ...
  // urlRutaEdif = featureProperties.rutaEdif;
  ...
  buttonRutaEdif(featureProperties)
